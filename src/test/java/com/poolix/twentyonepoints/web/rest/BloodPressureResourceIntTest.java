package com.poolix.twentyonepoints.web.rest;

import com.poolix.twentyonepoints.TwentyonepointsApp;

import com.poolix.twentyonepoints.domain.BloodPressure;
import com.poolix.twentyonepoints.repository.BloodPressureRepository;
import com.poolix.twentyonepoints.web.rest.errors.ExceptionTranslator;
...
import static com.poolix.twentyonepoints.web.rest.TestUtil.createFormattingConversionService;
...
public class BloodPressureResourceIntTest {
    ...
    private static final BigDecimal DEFAULT_SYSTOLIC = new BigDecimal(1);
    private static final BigDecimal UPDATED_SYSTOLIC = new BigDecimal(2);

    private static final BigDecimal DEFAULT_DIASTOLIC = new BigDecimal(1);
    private static final BigDecimal UPDATED_DIASTOLIC = new BigDecimal(2);
    ...
    public void getAllBloodPressures() throws Exception {
        ...
        restBloodPressureMockMvc.perform(get("/api/blood-pressures?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].systolic").value(hasItem(DEFAULT_SYSTOLIC.intValue())))
            .andExpect(jsonPath("$.[*].diastolic").value(hasItem(DEFAULT_DIASTOLIC.intValue())));
    }
    ...
    public void getBloodPressure() throws Exception {
        ...
        restBloodPressureMockMvc.perform(get("/api/blood-pressures/{id}", bloodPressure.getId()))
            ...
            .andExpect(jsonPath("$.systolic").value(DEFAULT_SYSTOLIC.intValue()))
            .andExpect(jsonPath("$.diastolic").value(DEFAULT_DIASTOLIC.intValue()));
    }
    @Test
    @Transactional
