...
import com.poolix.twentyonepoints.repository.PreferencesRepository;
...
public class PreferencesResourceIntTest {
    ...
    public void createPreferences() throws Exception {
        ...
        assertThat(testPreferences.getWeight_unit()).isEqualTo(DEFAULT_WEIGHT_UNIT);
    }
    ...
    @Test
    @Transactional
    public void checkWeight_unitIsRequired() throws Exception {
        int databaseSizeBeforeTest = preferencesRepository.findAll().size();
        // set the field null
        preferences.setWeight_unit(null);
    ...
    public void getAllPreferences() throws Exception {
        ...
        restPreferencesMockMvc.perform(get("/api/preferences?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].weight_unit").value(hasItem(DEFAULT_WEIGHT_UNIT.toString())));
    }
    ...
    public void getPreferences() throws Exception {
        ...
        restPreferencesMockMvc.perform(get("/api/preferences/{id}", preferences.getId()))
            ...
            .andExpect(jsonPath("$.weight_unit").value(DEFAULT_WEIGHT_UNIT.toString()));
    }
    @Test
    @Transactional
    ...
    public void updatePreferences() throws Exception {
        ...
        updatedPreferences
            ...
            .weight_unit(UPDATED_WEIGHT_UNIT);
        ...
        assertThat(testPreferences.getWeight_unit()).isEqualTo(UPDATED_WEIGHT_UNIT);
    }
